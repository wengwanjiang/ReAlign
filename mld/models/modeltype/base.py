...
from mld.models.metrics import TM2TMetrics, MMMetrics, PosMetrics
...
class BaseModel(nn.Module):
    ...
    def test_step(self, batch: dict, mode='test') -> None:
        return self.allsplit_step(mode, batch)
