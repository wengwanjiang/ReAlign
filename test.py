...
def main():
    ...
    # =================================================== # # =================================================== # 
    spm_path, lambda_t2m, lambda_m2m = cfg.spm_path, cfg.lambda_t2m, cfg.lambda_m2m
    if spm_path is not None:
        from ReAlignModule.models.spm import SPM
        reward_model = SPM(nfeats=263, t5_path=None, pretrained_path=spm_path, lambda_m2m=lambda_m2m, lambda_t2m=lambda_t2m).cuda()
        model.RewardModel = reward_model
    # =================================================== # # =================================================== # 
